...
import com.productandordermanagementsystem.backend.authservice.dto.AuthResponse;
import com.productandordermanagementsystem.backend.authservice.dto.LoginRequest;
import com.productandordermanagementsystem.backend.authservice.dto.RegisterRequest;
...
import com.productandordermanagementsystem.backend.authservice.exception.BadRequestException;
import com.productandordermanagementsystem.backend.authservice.repository.UserRepository;
import com.productandordermanagementsystem.backend.authservice.security.JwtService;
